...
public class ParameterName {
	...
	public static final String USER_VERIFICATION_PASSWORD = "verification_password";
	...
	public static final String REDIRECT = "from";
	public static final String AMONT_PAGE = "amont_page";
	public static final String CURRENT_PAGE = "current_page";
	public static final String SEARCH_QUESTION = "search_questions";
